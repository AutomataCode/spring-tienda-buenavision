...
public interface ProductoRepository extends JpaRepository<Producto, Long> {
    ...
    /*
    @Query("SELECT p FROM Producto p WHERE p.idProducto IN " +
           "(SELECT dp.producto.idProducto FROM DetallePedido dp GROUP BY dp.producto.idProducto ORDER BY SUM(dp.cantidad) DESC)")
    ...
    */
    ...
    @Query("SELECT p FROM Producto p WHERE " +
           ...
           "LOWER(p.color) LIKE LOWER(CONCAT('%', :searchTerm, '%'))) AND " +
           "p.estado =\"Activo\"")
